...
exports.addEntry = function(req, res, next){
  ...
  if (req.body.photo == '') {
    ...
    client.query('INSERT INTO skin.entry (userID, description, rating, date) VALUES ($1, $2, $3, $4) RETURNING id',
...
exports.addProductsUsed = function(req, res, next) {
  ...
  if (entryID != '' || productID != '') {
    if (rating == null) {
      ...
      console.log(rating);
      client.query("INSERT INTO skin.productused (entryid, productID, rating) VALUES ($1, $2, $3)", [entryID, productID, rating], function(err, qres) {
        if(err) {
